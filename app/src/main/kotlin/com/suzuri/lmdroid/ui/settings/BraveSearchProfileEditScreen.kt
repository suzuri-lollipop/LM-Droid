...
/** API設定 → profile list → this profile's edit form (name/API key) for a Brave Search profile — see [OpenAiCompatibleScreen] for the LLM-profile equivalent. */
@Composable
fun BraveSearchProfileEditScreen(
